...
def get_args():
    ...
    parser.add_argument(
        '--image-path',
        type=str,
        default='/home/krzysztof-kalisiak/Desktop/ROCM_repo/storage/RO/20.7442907820111|46.17330213362381|100|360|v.jpg',
        help='Input image path')
    parser.add_argument(
        '--labels',
        type=str,
        nargs='+',
        default=["a Romania", "a Poland", "a Bulgaria", "a France", "a Russia"],
    ...
    args.use_cuda = False #args.use_cuda and torch.cuda.is_available()
    if args.use_cuda:
...
class ImageClassifier(nn.Module):
    def __init__(self, labels):
        ...
        self.clip = CLIPModel.from_pretrained("openai/clip-vit-large-patch14").to('cpu')
...
if __name__ == '__main__':
    ...
    print(target_layers[0].weight.shape)
